...
SRC_URI += "file://2.46/comcast-RDKEMW-18589-WPE-Switch-gamepad-backend-from-libwpe-to-libmanette.patch"
SRC_URI += "file://2.46/comcast-RDKEMW-18589-Backport-Implement-playEffect-via-libmanette-rumble.patch"
SRC_URI += "file://2.46/comcast-RDKEMW-18589-WPE-Migrate-gamepad-backend-to-libmanette-1.0.patch"
SRC_URI += "file://2.46/comcast-RDKEMW-18589-gamepad-provider-toggle.patch"
...
PACKAGECONFIG:append = " ${@'gamepad manette-gamepad' if (d.getVar('PREFERRED_VERSION_libmanette') or '').startswith('1.0') else ''}"
